...
public class ObjectFactory {
    ...
    private final static QName _ItensPeloCodigo_QNAME = new QName("http://caelum.com.br/estoque/v1", "ItensPeloCodigo");
    private final static QName _ItensPeloCodigoResponse_QNAME = new QName("http://caelum.com.br/estoque/v1", "ItensPeloCodigoResponse");
    private final static QName _TokenUsuario_QNAME = new QName("http://caelum.com.br/estoque/v1", "tokenUsuario");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://caelum.com.br/estoque/v1", name = "ItensPeloCodigo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://caelum.com.br/estoque/v1", name = "ItensPeloCodigoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://caelum.com.br/estoque/v1", name = "tokenUsuario")
